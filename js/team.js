...
(() => {
 ...
 const actionName={grant_admin:'管理者権限を付与',answer:'出欠を更新',member:'名簿を更新',archive_member:'メンバーの利用状態を変更',event:'予定を保存',delete_event:'予定を削除',guest:'助っ人を更新',notice:'伝達事項を更新',ledger:'会計を保存',delete_ledger:'会計を削除',bib:'ビブスを更新',settings:'設定を更新',rotate_link:'共有リンクを変更',undo_answer:'出欠を取り消し'};
 ...
 document.addEventListener('submit',async e=>{
  ...
  if(edit.id)p.id=edit.id;p.squad=squad;delete p.place_preset;delete p.time_preset;
